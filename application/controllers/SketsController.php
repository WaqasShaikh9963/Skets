<?php
class SketsController extends CI_Controller{
    ...
    public function Register_User() {     //      User Register Function
        $this->libery();
        ...
        //$this->load->view("Skets");
       redirect('http://localhost/Skets/index.php/SketsController');
        
    }     //   User Register Function    
      
    public function login(){    // login function start
